    ...
    <div class="d-flex justify-content-center">
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" action="/facility?action=create"
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="standardRoom" class="form-control" placeholder="Input standard Room" name="standardRoom">
                    <span class="input-group-text"><i class="fa-solid fa-id-card"></i></span>
                </div>
            </div>

            <div class="mt-3 form-group">
                <label for="descriptionOtherConvenience" class="h6">Description:</label>
                <div class="input-group">
                    <input type="text" id="descriptionOtherConvenience" class="form-control" placeholder="Input Description Other Convenience" name="descriptionOtherConvenience">
                    <span class="input-group-text"><i class="fa-solid fa-square-phone"></i></span>
                </div>
            </div>

            <div class="mt-3 form-group">
                <label for="poolArea" class="h6">Pool Area:</label>
                <input type="number" id="poolArea" class="form-control" name="poolArea">
            </div>

            <div class="mt-3 form-group">
                <label for="numberOfFloors" class="h6">floors:</label>
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="facilityFree" class="form-control" placeholder="Input Facility Free" name="facilityFree">
